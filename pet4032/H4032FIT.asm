; H4032FIT — Annotated 6502 source
;
; CURSOR #18-style pseudo-hi-res for a CRTC PET 4032.
; Displays artwork different from 2001 version such that it fits within
; the narrower possible display area on a PET 4032.
